...
if __name__ == "__main__":
    ...
    if first == "bot":
        ...
        console.print()
        report = scan_company(first, domain)
        # Print to terminal (strip HTML tags for console)
        import re
        clean = re.sub(r"<[^>]+>", "", report)
        console.print(Panel(clean, title=f"\U0001f6a8 [bold]{first}[/bold]", border_style="yellow", padding=(1, 2)))
